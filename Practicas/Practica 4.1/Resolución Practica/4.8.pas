...
begin
  cumple:=1; 
  while(dni<>0) and (cumple=1)do begin
    dig:= dni mod 10;
...
begin
  ...
  writeln('Apellido y nombre de los 2 alumnos de mayor edad: ',nom1,' ',ape1,' y ',nom2,' y ',ape2);
  writeln('El porcentaje de alumnos con DNI compuesto solo por digitos pares ',(contador/100*dimf):0:2); 
end;
